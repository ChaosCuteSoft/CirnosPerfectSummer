label chEpilogue:
    ...
    show cirno summer happy
    show moka happy at right
    show sakuya smile at left
    "Cirno and the other girls walked the length of the park, each with an ice cream cone in hand."
